...
const ThreadForm = () => {
    return (
        ...
        }} className="w-full bg-[rgba(255,255,255,0.14)] px-4 py-2">
            <div className='min-h-[60px] w-full border rounded-lg flex flex-col gap-4 justify-between'>
                <textarea placeholder="Write your Thread here..." className="h-[40px] p-4 bg-transparent resize-none outline-none"></textarea>
