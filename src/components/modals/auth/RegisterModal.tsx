            ...
            >
              <div className="w-full flex flex-col gap-2">
                {RegisterFormData?.map((formdata, index) => {
                  return (
                    ...
                    >
                      <span className="text-[#939393] font-work_font">
                        {formdata?.text}
                      </span>
                      <input
                        type={formdata?.type}
              ...
              <div className="w-full mt-2 flex items-center justify-center flex-col gap-3">
                <button
                  ...
                  type="submit"
                  disabled={noEntry}
                  className="p-3 px-8 hover:opacity-[.5] text-[#fff] flex btn items-center justify-center w-full cursor-pointer  bg-[#000] rounded-md font-selleasy_regular"
                >
                  {isLoading ? (
                ...
                <div className="w-full flex items-center justify-start gap-2">
                  <span className="text-sm font-normal font-selleasy_regular text-dark">
                    <span className="">Already a Seller?</span>{" "}
                    <span
